...
export const StudentCreateNestedManyWithoutGradeInputSchema: z.ZodType<Prisma.StudentCreateNestedManyWithoutGradeInput> = z.object({
...
export default StudentCreateNestedManyWithoutGradeInputSchema;
