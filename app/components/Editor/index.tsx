          ...
          <RichTextPlugin
            ...
            contentEditable={
              <ContentEditable
                ...
                className="h-14 rounded-b-md rounded-t-none border border-solid border-slate-600 px-4 outline-none focus:border-2 focus:border-blue-400 dark:border-slate-700"
              />
            }
